        ...
        while(counter < 10000) {
            ...
            if((row+col) % 2 == 0) {
                ...
                for(int r = 0; r < 40; r++) { 
                    for(int c = 0; c < 40; c++) {
                        if((r+c) % 2 == 0) {
                            if((tileColors[r][c].equals(Color.GREEN) || tileColors[r][c].equals(Color.RED) || tileColors[r][c].equals(Color.YELLOW) || tileColors[r][c].equals(Color.MAGENTA))
                                    && distance(row, col, r, c) < 2) okay = false;
                        }
                    }
                } */
