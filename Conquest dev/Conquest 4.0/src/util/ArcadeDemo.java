...
public class ArcadeDemo extends AnimationPanel implements ActionListener
{
    ...
    protected Graphics renderFrame(Graphics g) 
    {
        ...
        g.drawString("Level " + soldierLevel + " Soldier ($" + 10*soldierLevel + ", -" + soldierCost(soldierLevel) + ")", 1030, 210);
        ...
        g.setColor(Color.BLACK);
        g.setFont(new Font("Arial", Font.BOLD, 12));
        g.drawString("Farm ($" + farmPrice + ", +4)", 1030, 310);
        ...
        g.setColor(Color.BLACK);
        g.setFont(new Font("Arial", Font.BOLD, 12));
        g.drawString("Level " + towerLevel + " Tower ($" + towerPrice(towerLevel) + ", -" + towerCost(towerLevel) + ")", 1030, 410);
        ...
        g.setColor(Color.BLACK);
        g.setFont(new Font("Arial", Font.BOLD, 12));
        g.drawString("Level " + shipLevel + " Ship ($" + shipPrice(shipLevel) + ", -" + shipCost(shipLevel) + ")", 1030, 510);
    ...
    public static int shipPrice(int level) {
        ...
        return shipPrice(level - 1) + shipPrice(level - 2);
    }
